...
def rare_standalone(
    ...
    nPoints = np.array([60, 1, 1]), # Number of points along readout, phase and slice
    ...
    def createSequence():
        ...
        for repeIndex in range(nRepetitions):
            ...
            if repeIndex>=dummyPulses and preExTime!=0:
                ...
                rfRecPulse(t0,rfExTime,rfExAmp/90*90,0)
            ...
            for echoIndex in range(etl):
                ...
                if repeIndex>=dummyPulses:         # This is to account for dummy pulses
                    gradTrap( 0, phGradTime, phGradients[phIndex], axes[1])
