...
class tRFcalibration(blankSeq.MRIBLANKSEQ):
    def __init__(self):
        super(tRFcalibration, self).__init__()
        # Input the parameters
        self.addParameter(key='seqName', string='tRFcalibration', val='tRFcalibration')
